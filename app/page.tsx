        ...
        <div className="page-shell relative grid gap-12 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-300">
              ...
              product discovery, applied research, and client-ready deliverables.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/client-workspace" className="rounded-full bg-white px-5 py-3 text-sm font-semibold text-black hover:bg-emerald-300">
                Open Client Workspace
              </Link>
              <Link href="/client-workspace#terminal" className="rounded-full border border-white/20 px-5 py-3 text-sm font-semibold text-white hover:border-cyan-300 hover:text-cyan-300">
                Launch Terminal
              </Link>
            </div>
            ...
            {capabilities.map((item) => (
              <div key={item} className="bg-black p-6">
                ...
                <p className="mt-4 text-sm leading-6 text-zinc-400">
                  Composable infrastructure for secure research, modeling,
        ...
        <div className="page-shell">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2">
            {products.map((product) => (
              <article key={product.name} className="border border-white/10 bg-black p-6">
